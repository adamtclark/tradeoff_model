...
par(mar=c(2,2,2,1), oma=c(4,3,0.5,0))
############################################################
...
#Labels
############################################################
mtext(expression(paste("Predicted Biomass, g m"^-2)), side = 1, outer = TRUE, adj = 0.75, line=2, cex=1.2)
mtext("Original Model", side = 3, outer = TRUE, adj = 0.54, line=-1.5)
mtext("Augmented Model", side = 3, outer = TRUE, adj = 0.92, line=-1.5)
