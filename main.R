...
############################################################
pdf("figures/Figure1_tradeoff_surface_3D.pdf", width=6, height=6, colormodel = "cmyk", useDingbats = FALSE)
...
############################################################
#plot coexistence
pdf("figures/Figure2_coexistence_predictions.pdf", width=6, height=3, colormodel = "cmyk", useDingbats = FALSE)
...
pdf("figures/Figure3_fit_figure.pdf", width=8, height=9, colormodel = "cmyk", useDingbats = FALSE)
...
############################################################
pdf("figures/Figure4_simulated_community.pdf", width=8, height=4, colormodel = "cmyk", useDingbats = FALSE)
